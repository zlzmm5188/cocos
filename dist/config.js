...
const ApiService = {
    ...
    ribao: {
        async getInfo() {
            const res = await http.get('/user/api/ribao/info');
            return res.data || {};
        },
        async transferIn(payload) {
            const res = await http.post('/user/api/ribao/transfer-in', payload);
            return res.data || {};
        },
        async transferOut(payload) {
            const res = await http.post('/user/api/ribao/transfer-out', payload);
            return res.data || {};
        },
        async getRecords(params = {}) {
            const res = await http.get('/user/api/ribao/records', params);
            return res.data || {};
        }
    },
    ...
    points: {
        ...
        async getLogs(params = {}) {
            const res = await http.get('/user/points/logs', params);
            return res.data || {};
        }
    },
