...
async function loadRibaoData() {
    ...
    try {
        ...
        if (typeof ApiClient !== 'undefined') {
            try {
                headData = await ApiClient.get('/user/api/ribao/head');
            } catch (e) {
...
async function loadProfitRecords() {
    ...
    try {
        ...
        if (typeof ApiClient !== 'undefined') {
            try {
                response = await ApiClient.get('/user/api/ribao/list', {
...
async function handleTransferIn() {
    ...
    try {
        ...
        let response = null;
        if (typeof ApiClient !== 'undefined') {
            response = await ApiClient.post('/user/api/ribao/in', {
                money: amount
            });
        } else {
...
async function handleTransferOut() {
    ...
    try {
        ...
        let response = null;
        if (typeof ApiClient !== 'undefined') {
            response = await ApiClient.post('/user/api/ribao/out', {
                money: amount
            });
        } else {
            throw new Error('ApiClient未加载');
