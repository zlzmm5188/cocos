...
async function submitIdCardInfo() {
    ...
    try {
        // 调用后端身份证验证接口
        const response = await fetch('https://api.4kp3l0iq.top/apiuser/verify/idcard', {
            method: 'POST',
...
async function captureAIFace() {
    ...
    try {
        const response = await fetch('https://api.4kp3l0iq.top/apiuser/verify/face-idcard', {
            method: 'POST',
            headers: {'Content-Type': 'application/json'},
            body: JSON.stringify({
...
async function submitNewPassword() {
    ...
    try {
        const response = await fetch('https://api.4kp3l0iq.top/apiuser/password/reset-verified', {
            method: 'POST',
            headers: {'Content-Type': 'application/json'},
            body: JSON.stringify({
                user_id: resetData.userId,
