...
class UnifiedApiClient {
    constructor() {
        this.baseURL = window.API_CONFIG?.baseURL || 'http://localhost:8888/api';
    ...
    async request(endpoint, options = {}) {
        ...
        try {
            ...
            if (text.trim().startsWith('<!DOCTYPE') || text.trim().startsWith('<html') ||
                ...
                console.error('[API] 返回HTML错误页面:', text.substring(0, 200));
            ...
            try {
                ...
                console.error('[API] JSON解析失败:', text.substring(0, 200));
